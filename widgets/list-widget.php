...
class Elementor_List_Widget extends \Elementor\Widget_Base {
    ...
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'style-handle', ELEMENTOR_URL_PLUGIN_CUSTOM.'path/to/file.css');
        wp_register_script( 'script-handle', ELEMENTOR_URL_PLUGIN_CUSTOM.'path/to/file.js', [ 
